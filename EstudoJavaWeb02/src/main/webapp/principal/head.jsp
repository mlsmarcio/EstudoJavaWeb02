<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Sistema para aprendizagem JAVA, JSP, SERVLET, JDBC, BOOTSTRAP 4," />
      <meta name="keywords" content="bootstrap, responsive" />
      <meta name="author" content="Márcio Lopes" />
      <!-- Favicon icon -->
